<template>
  <div class="cameras-container">
        ...
        <el-table-column label="操作" width="300" fixed="right">
          <template #default="{ row }">
            <div class="row-actions">
              ...
              <el-popconfirm title="确认删除该设备？" @confirm="handleDelete(row.id)">
                <template #reference>
    ...
    <el-dialog v-model="formVisible" :title="isEdit ? '编辑设备' : '新增设备'" width="520px">
    ...
    <el-dialog v-model="logVisible" :title="`设备日志：${logCameraName}`" width="560px">
      <el-timeline>
        <el-timeline-item
